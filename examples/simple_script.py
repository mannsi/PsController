...
import sys
import time
hardware_interface = DeviceFactory().get_device("usb")
...
hardware_interface.set_output_on(True)  # Turn output on
...
hardware_interface.set_output_on(False)  # Turn output off
