...
_characters_to_escape = [START, ESCAPE, NEW_LINE, RETURN]  # Int values of characters to escape
...
class Crc16:
    ...
    def create(cls, command, binaryData):
        ...
        escapedIntCrcCode = cls._escapeCrcCode(unescapedHexCrc, _characters_to_escape)
